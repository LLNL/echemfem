...
class CarbonateSolver(EchemSolver):
    ...
    def __init__(self):
        ...
        def bulk_reaction(C):
            s = [-k1f * C[0] * C[1] + k1r * C[4] - k2f * C[0] + k2r * C[4] * C[2],
                 -k1f * C[0] * C[1] + k1r * C[4] + k3f * C[3] - k3r * C[4] * C[1] - k5f * C[1] * C[2] + k5r,
                 + k2f * C[0] - k2r * C[4] * C[2] - k4f * C[3] * C[2] + k4r * C[4] - k5f * C[1] * C[2] + k5r,
                 - k3f * C[3] + k3r * C[4] * C[1] - k4f * C[3] * C[2] + k4r * C[4],
                 k1f * C[0] * C[1] - k1r * C[4] + k2f * C[0] - k2r * C[4] * C[2] + k3f * C[3] - k3r * C[4] * C[1] + k4f * C[3] * C[2] - k4r * C[4]]
            return s
...
solver.setup_solver()
solver.solve()
C_CO2, C_OH, C_H, C_CO3, C_HCO3 = solver.u.split()
# OH boundary layer
